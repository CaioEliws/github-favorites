...
export class Favorites {
    ...
    delete(user) {
        // Higher-oder functions (map, filter, find, reduce)
...
export class FavoritesView extends Favorites {
    ...
    createRow() {
        ...
        tr.innerHTML = `
                <td class="user">
                    <img src="https://github.com/EduardoBravoP.png" alt="Imagem de EduardoBravoP">
                    <a href="https://github.com/EduardoBravoP" target="_blank">
                        <p>Eduardo Bravo</p>
                        <span>EduardoBravoP</span>
                    </a>
                </td>
